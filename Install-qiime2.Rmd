...
output:
  html_document:
    df_print: paged
---
## Get your own Linux virtual machine
...
1. Log in in through Terminal (MacOS) or PowerShell (Win) using the ssh command and pasting in your NETID@HOSTNAME. Hostname is found in the general information page on the Duke VM website. The command prompt may ask if you are sure you want to continue connecting - type "yes". 
    ```{bash, eval=FALSE}
    ssh NETID@HOSTNAME
